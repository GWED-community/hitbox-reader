...
--gui.drawImage("images/Portrait09.png", 0, 0, 84, 155) 
	...
	elseif gamestate == 8 and matchstate == 32 then
		...
		if option[7] == -1 then
			if mainmemory.read_u8(0x1000) == 30 then
				mainmemory.write_u8(0x1010, 0)
			else
				mainmemory.write_u8(0x1010, 4)
			end
			if mainmemory.read_u8(0x1004) == 30 then
				mainmemory.write_u8(0x1014, 0)
			else
				mainmemory.write_u8(0x1014, 4)
			end
		elseif option[7] == 1 then
			if mainmemory.read_u8(0x1000) == 30 then
				mainmemory.write_u8(0x1010, 0)
			else
				mainmemory.write_u8(0x1010, 8)
			end
			if mainmemory.read_u8(0x1004) == 30 then
				mainmemory.write_u8(0x1014, 0)
			else
				mainmemory.write_u8(0x1014, 8)
			end
		end
		----------------------------------------
		settings()
