...
local function projectiles()
	...
	for i = 0,3, 1 do
		...
		local pjposx    = mainmemory.read_s16_le((pjstart + (i*0x04) ) + 0x01)
		local pjposy    = mainmemory.read_s16_le((pjstart + (i*0x04) ) + 0x80 + 0x01)
		local pjlengthx = mainmemory.read_s16_le((pjstart + (i*0x04) ) + 0x800 + 0x02)
		local pjlengthy = mainmemory.read_s16_le((pjstart + (i*0x04) ) + 0x800 + 0x80 + 0x02)			
